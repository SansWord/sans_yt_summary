...
| [tweet_zh.md](./prompts/tweet_zh.md) | Compress into a tweet thread in Traditional Chinese | Sharing, social media | [view](./outputs/tweet_zh.md) |
| [summarize_system_design_en.md](./prompts/summarize_system_design_en.md) | System design analysis in English | Tech interviews — ⚠️ this video is clearly not a system design video | [view](./outputs/summarize_system_design_en.md) |
